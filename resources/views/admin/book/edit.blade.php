        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Book Data </h3>
                </div>
                    <div class="card-body">
                        <form action="{{route('admin.book.update', $book)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Book Title" value="{{$book->title ?? old ('title')}}">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Add Description Book">{{$book->description ?? old ('description')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Add Book Qty" value="{{$book->qty ?? old ('qty')}}">
                                @error('qty')
                                    <span class="help-block">{{$message}}</span>
                                @enderror
                            </div>
